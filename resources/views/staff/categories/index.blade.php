                ...
                <td class="px-4 py-4 sm:px-6">
                  <div class="flex items-center justify-end gap-2">
                    ...
                    @can('manage-categories')
                      ...
                      <form action="{{ route('staff.categories.destroy', $category) }}" method="POST" onsubmit="return confirm('Delete this category? Categories with services will be marked inactive instead.')">
                        @csrf
                        @method('DELETE')
                        <button type="submit" title="Delete category" aria-label="Delete category" class="text-gray-500 hover:text-error-600 dark:text-gray-400">
                          <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
