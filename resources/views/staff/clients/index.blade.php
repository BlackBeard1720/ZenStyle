    ...
    >
      <div class="px-5 py-4 sm:px-6 sm:py-5">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <h3 class="text-base font-medium text-gray-800 dark:text-white/90">Clients list</h3>

          <div class="flex items-center gap-2">
            <!-- ADD CLIENT BUTTON -->
            <a href="{{ route('staff.clients.create') }}"
            ...
            <div class="relative flex items-center gap-3" x-data="{ openFilter: false }">
              ...
              <!-- FILTER POPUP -->
              <x-staff.partials.client-filter-popup/>
            </div>
          </div>
        </div>
      </div>
              ...
              @foreach($clients as $client)
                ...
                <tr>
                  <td class="px-4 pb-3 pt-4 sm:px-6">
                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $client->id }}</p>
                  </td>
                  ...
                  <td class="px-4 pb-3 pt-4 sm:px-6">
                    <div class="flex items-center gap-3">
                      ...
                      <div class="h-10 w-10 overflow-hidden rounded-full bg-gray-100">
                        <img src="https://ui-avatars.com/api/?name={{ urlencode($client->full_name) }}" alt="Client"/>
                      </div>
                  ...
                  <td class="px-4 pb-3 pt-4 sm:px-6">
                    <div class="flex items-center justify-end gap-2">
                      ...
                      <!-- View -->
                      <a href="{{ route('staff.clients.show', $client) }}"
                      ...
                      <!-- Edit -->
                      <a href="{{ route('staff.clients.edit', $client) }}"
                      ...
                      <x-staff.confirm-action
                        action="{{ route('staff.clients.destroy', $client) }}"
                        method="DELETE"
                        title="Delete Client"
