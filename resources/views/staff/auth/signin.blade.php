<x-staff.layout
    title="Sign In | ZenStyle"
    page-name="signin"
    :show-header-side="false"
>
    <!-- ===== Page Wrapper Start ===== -->
    <div class="relative z-1 flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-gray-100 via-white to-brand-50 p-6 dark:bg-gray-900 dark:bg-none">
        <div class="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(70,95,255,0.10),_transparent_34%),radial-gradient(circle_at_bottom_left,_rgba(70,95,255,0.08),_transparent_28%)] dark:hidden"></div>

        <!-- ===== Common Grid Shape Start ===== -->
        <div class="opacity-60 dark:opacity-100">
            <x-staff.partials.common-grid-shape />
        </div>
        <!-- ===== Common Grid Shape End ===== -->

        <!-- Login Card -->
        <div class="relative w-full max-w-md rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-xl dark:border-gray-800 dark:bg-gray-900 sm:p-8">
            <div class="mb-6 text-center sm:mb-8">
                <div class="mb-4 flex items-center justify-center gap-3">
                    <span class="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-500 text-lg font-semibold text-white shadow-theme-xs">
                        Z
                    </span>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Sign in with your staff account to manage ZenStyle.
                </p>
            </div>
