    ...
    <div class="p-5 sm:p-6">
      <form method="GET" action="{{ route('staff.news.index') }}" class="mb-5 grid grid-cols-1 gap-4 md:grid-cols-6">
        ...
        <div class="flex items-center gap-2 md:col-span-6 lg:col-span-1">
          <button type="submit" class="inline-flex h-11 flex-1 items-center justify-center rounded-lg bg-brand-500 px-4 text-sm font-medium text-white hover:bg-brand-600">Search</button>
          <a href="{{ route('staff.news.index') }}" class="inline-flex h-11 flex-1 items-center justify-center rounded-lg border border-gray-300 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-800">Reset</a>
        </div>
      </form>
          ...
          <table class="min-w-full table-fixed">
            ...
            @forelse($items as $item)
              ...
              <tr class="align-top">
                ...
                <td class="px-4 py-4 sm:px-6">
                  <div class="h-12 w-20 overflow-hidden rounded-lg border border-gray-100 bg-gray-50 dark:border-gray-800 dark:bg-gray-900">
                ...
                <td class="px-4 py-4 sm:px-6">
                  <div class="flex items-center justify-end gap-2">
                    ...
                    <a href="{{ route('staff.news.edit', $item) }}" title="Edit news" class="text-gray-500 hover:text-blue-600 dark:text-gray-400">
                      <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16.862 4.487 18.55 2.8a1.875 1.875 0 0 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Z"/>
            ...
            @empty
              <tr>
                <td colspan="7" class="px-4 py-8 text-center text-sm text-gray-500 dark:text-gray-400">No news found.</td>
              </tr>
            @endforelse
            </tbody>
          </table>
