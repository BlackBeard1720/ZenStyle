              ...
              <tr class="align-top">
                ...
                <td class="px-4 py-4 sm:px-6">
                  <div class="flex items-center justify-end gap-2">
                    ...
                    <form action="{{ route('staff.news.destroy', $item) }}" method="POST"
                          onsubmit="return confirm('Hide this news item?')">
                      @csrf
                      @method('DELETE')
                      <button type="submit" title="Hide news" aria-label="Hide news"
