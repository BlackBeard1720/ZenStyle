                  ...
                  <div class="flex items-center justify-end gap-2">
                    ...
                    @can('manage-services')
                      ...
                      <x-staff.confirm-action
                        action="{{ route('staff.services.destroy', $service) }}"
                        method="DELETE"
                        title="Delete Service"
                        message="Delete this service? Services with appointments will be marked inactive instead."
                        variant="danger"
                      >
                        <button type="button" title="Delete service" aria-label="Delete service" class="text-gray-500 hover:text-error-600 dark:text-gray-400">
                          <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
