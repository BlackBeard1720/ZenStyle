<x-staff.layout title="Services" page-name="ServicesManagement">
  ...
  <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
    ...
    <div class="p-5 sm:p-6">
      <form method="GET" action="{{ route('staff.services.index') }}" class="mb-5 grid grid-cols-1 gap-4 md:grid-cols-4">
        <input
          type="text"
          name="keyword"
      ...
      <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="w-full overflow-x-auto">
          <table class="min-w-full table-fixed">
            ...
            @empty
              <tr>
                <td colspan="7" class="px-4 py-8 text-center text-sm text-gray-500 dark:text-gray-400">No services found.</td>
              </tr>
            @endforelse
            </tbody>
          </table>
