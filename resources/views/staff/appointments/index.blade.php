        ...
        <div class="w-full overflow-x-auto">
          <table class="min-w-full table-fixed">
            ...
            <tr class="border-b border-gray-100 dark:border-gray-800">
              ...
              <th class="w-36 px-4 pb-3 pt-4 text-left sm:px-6">
                <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Total (USD)</p>
              </th>
              <th class="w-32 px-4 pb-3 pt-4 text-left sm:px-6">
                <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Status</p>
              </th>
              <th class="w-40 px-4 pb-3 pt-4 text-right sm:px-6">
            ...
            @forelse($appointments as $appointment)
              ...
              <tr class="align-top">
                ...
                <td class="px-4 py-4 sm:px-6"><p class="whitespace-nowrap text-theme-sm text-gray-500 dark:text-gray-400">{{ number_format($appointment->total_amount) }}</p></td>
                ...
                <td class="px-4 py-4 sm:px-6">
                  <div class="flex items-center justify-end gap-2 whitespace-nowrap">
                    ...
                    @elseif($appointment->isPaid())
                      <span class="inline-flex min-w-[76px] items-center justify-center rounded-md bg-success-50 px-2.5 py-1 text-center text-xs font-medium text-success-600 dark:bg-success-500/15 dark:text-success-500">
        Paid
      </span>
                    @else
                      <span class="inline-flex min-w-[76px] items-center justify-center rounded-md px-2.5 py-1 text-center text-xs font-medium text-gray-400 dark:text-gray-500">
        -
      </span>
                    @endif
                    ...
                    <a href="{{ route('staff.appointments.show', $appointment) }}"
                       ...
                       class="inline-flex items-center justify-center rounded-md border border-gray-300 px-2.5 py-1 text-xs font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-800">
                      Detail
                    </a>
                  </div>
                </td>
