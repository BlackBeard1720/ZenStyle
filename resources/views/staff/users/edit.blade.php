...
>
  <!-- ===== BREADCRUMB: Hiển thị tiêu đề trang "Edit Staff Account" ===== -->
  <div x-data="{ pageName: `Edit Staff Account`}">
      ...
      <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <form method="POST" action="{{ route('staff.users.update', $user->id) }}" class="p-5 sm:p-6 space-y-6"
          ...
          <!-- Cancel: Quay lại danh sách người dùng
               Update Staff Account: Gửi form để cập nhật thông tin người dùng -->
