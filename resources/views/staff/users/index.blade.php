                        ...
                        <table class="min-w-full">
                            ...
                            @foreach($users as $user)
                                ...
                                Active
                                        ...
                                        @else
                                            <span class="inline-flex items-center justify-center gap-1 rounded-full bg-error-50 px-2.5 py-0.5 text-xs font-medium text-error-600 dark:bg-error-500/15 dark:text-error-500">
                                Inactive
                            </span>
                                        @endif
                                    </td>
