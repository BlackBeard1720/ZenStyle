...
@section('content')
    ...
    <div x-data="{ pageName: `Form Elements`}">
        @include('layouts.staff.partials.breadcrumb')
    </div>
    <!-- Breadcrumb End -->
                ...
                <form method="POST" action="{{ route('staff.users.store') }}" class="p-5 sm:p-6 space-y-6"
                    ...
                    <div>
                        ...
                        <div x-data="{ showPassword: false }" class="relative">
                            <input :type="showPassword ? 'text' : 'password'" name="password" placeholder="Min. 6 characters"  minlength="6"
                            ...
                            <span @click="showPassword = !showPassword" class="absolute top-1/2 right-4 z-30 -translate-y-1/2 cursor-pointer">
                                ...
                                <!-- Eye Opened Icon -->
                                <svg x-cloak x-show="showPassword" class="fill-gray-500 dark:fill-gray-400" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        ...
                        <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                            <select name="role_id"
                                ...
                                <option value="" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" disabled selected>Select Role</option>
                                <option value="1" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" @selected(old('role_id') == '1')>Admin</option>
                                <option value="2" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" @selected(old('role_id') == '2')>Receptionist</option>
                                <option value="3" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" @selected(old('role_id') == '3')>Stylist</option>
                            </select>
                    ...
                    <div class="flex items-center justify-end gap-3 border-t border-gray-100 pt-5 dark:border-gray-800">
                        <a href="{{ route('staff.users.index') }}" class="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-5 py-2.5 text-center text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700">
                            Cancel
                        </a>
                        <button type="submit" class="inline-flex items-center justify-center rounded-lg bg-brand-500 px-5 py-2.5 text-center text-sm font-medium text-white shadow-theme-xs hover:bg-brand-600">
                            Save User
                        </button>
                    </div>
