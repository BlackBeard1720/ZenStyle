<x-frontend.layout title="ZenStyle — Chính sách bảo mật" main-class="bg-stone-50 pt-20">
    <section class="border-b border-stone-200/70 bg-white px-4 py-12 sm:px-6 sm:py-14">
        <div class="mx-auto max-w-4xl">
            <p class="text-xs font-semibold uppercase tracking-[0.2em] text-rose-700">Privacy policy</p>
            ...
            <p class="mt-2 text-xs text-stone-500">Cập nhật lần cuối: {{ now()->format('d/m/Y') }}</p>
        </div>
    </section>

    <section class="px-4 py-10 sm:px-6 sm:py-12">
        <article class="mx-auto max-w-4xl rounded-2xl border border-stone-200 bg-white p-6 shadow-sm sm:p-8">
            <div class="space-y-8 text-sm leading-relaxed text-stone-700 sm:text-base">
                <section>
                    <h2 class="text-lg font-semibold text-stone-900 sm:text-xl">1. Phạm vi thu thập thông tin</h2>
                    <p class="mt-2">
                ...
                <section>
                    <h2 class="text-lg font-semibold text-stone-900 sm:text-xl">2. Mục đích sử dụng thông tin</h2>
                ...
                <section>
                    <h2 class="text-lg font-semibold text-stone-900 sm:text-xl">3. Lưu trữ và bảo mật dữ liệu</h2>
                    <p class="mt-2">
                ...
                <section>
                    <h2 class="text-lg font-semibold text-stone-900 sm:text-xl">4. Chia sẻ thông tin với bên thứ ba</h2>
                    <p class="mt-2">
                ...
                <section>
                    <h2 class="text-lg font-semibold text-stone-900 sm:text-xl">5. Quyền của khách hàng</h2>
                    <p class="mt-2">
                ...
                <section>
                    <h2 class="text-lg font-semibold text-stone-900 sm:text-xl">6. Liên hệ</h2>
                    <p class="mt-2">
                        Nếu có câu hỏi liên quan đến chính sách bảo mật, vui lòng liên hệ:
                        <a href="mailto:hello@zenstyle.vn" class="font-medium text-rose-700 hover:text-rose-800">
                            hello@zenstyle.vn
                        </a>
                        hoặc
                        <a href="tel:+84901234567" class="font-medium text-rose-700 hover:text-rose-800">
                            0901 234 567
                        </a>.
                    </p>
                </section>
