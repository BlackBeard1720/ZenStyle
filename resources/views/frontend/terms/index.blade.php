    ...
    <section class="px-4 py-10 sm:px-6 sm:py-12">
        <article class="mx-auto max-w-4xl rounded-2xl border border-stone-200 bg-white p-6 shadow-sm sm:p-8">
            <div class="space-y-8 text-sm leading-relaxed text-stone-700 sm:text-base">
                <section>
                    <h2 class="text-lg font-semibold text-stone-900 sm:text-xl">1. Phạm vi áp dụng</h2>
                    <p class="mt-2">
                ...
                <section>
                    <h2 class="text-lg font-semibold text-stone-900 sm:text-xl">2. Quy định đặt lịch</h2>
                ...
                <section>
                    <h2 class="text-lg font-semibold text-stone-900 sm:text-xl">3. Giá dịch vụ và thanh toán</h2>
                    <p class="mt-2">
                ...
                <section>
                    <h2 class="text-lg font-semibold text-stone-900 sm:text-xl">4. Khuyến mãi và ưu đãi</h2>
                    <p class="mt-2">
                ...
                <section>
                    <h2 class="text-lg font-semibold text-stone-900 sm:text-xl">5. Trách nhiệm người dùng</h2>
                ...
                <section>
                    <h2 class="text-lg font-semibold text-stone-900 sm:text-xl">6. Giới hạn trách nhiệm</h2>
                    <p class="mt-2">
                ...
                <section>
                    <h2 class="text-lg font-semibold text-stone-900 sm:text-xl">7. Thay đổi điều khoản</h2>
                    <p class="mt-2">
                ...
                <section>
                    <h2 class="text-lg font-semibold text-stone-900 sm:text-xl">8. Thông tin liên hệ</h2>
                    <p class="mt-2">
